...
const GRANDFATHERED: Readonly<Record<string, number>> = {
	"hosts/terminal/engine/test/desktop-notify.test.ts": 4,
	"hosts/terminal/engine/test/loader.test.ts": 25,
	"hosts/terminal/engine/test/loop-watchdog-wiring.test.ts": 2,
	"hosts/terminal/engine/test/notifications-respect-window-focus.test.ts": 4,
	"hosts/terminal/engine/test/notifications.test.ts": 4,
	...
	"packages/coding-agent/src/modes/terminal/components/composer/custom-editor.test.ts": 1,
	"packages/coding-agent/src/modes/terminal/controllers/extension-ui-controller.test.ts": 4,
	...
	"packages/coding-agent/test/discovery/capability/fs-special-files.test.ts": 3,
	...
	"packages/coding-agent/test/gran-1-agent-durable-session.test.ts": 2,
	...
	"packages/coding-agent/test/input-controller-escape.test.ts": 95,
	...
	"packages/coding-agent/test/task/irc/bus-traffic-log.test.ts": 2,
	...
	"packages/coding-agent/test/modes/terminal/components/agent-dashboard-age-ticker.test.ts": 4,
	"packages/coding-agent/test/modes/terminal/components/agent-dashboard-roster-order.test.ts": 4,
	"packages/coding-agent/test/modes/terminal/components/agent-transcript-viewer.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/components/ask-dialog.test.ts": 55,
	"packages/coding-agent/test/modes/terminal/components/copy-selector.test.ts": 3,
	"packages/coding-agent/test/modes/terminal/components/custom-editor-bash-background-fallthrough.test.ts": 3,
	"packages/coding-agent/test/modes/terminal/components/plan-review-overlay.test.ts": 18,
	"packages/coding-agent/test/modes/terminal/components/plugin-list-marketplace.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/components/the-extensions-dashboard-fades-both-its-bands.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/components/the-login-card-answers-the-pointer.test.ts": 5,
	"packages/coding-agent/test/modes/terminal/components/the-login-screen-is-one-frame.test.ts": 2,
	"packages/coding-agent/test/modes/terminal/components/the-model-cards-fade-every-band-they-own.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/components/the-plugins-tab-answers-the-pointer.test.ts": 2,
	"packages/coding-agent/test/modes/terminal/components/the-transcript-card-answers-the-pointer.test.ts": 6,
	"packages/coding-agent/test/modes/terminal/components/tool-execution-background-task.test.ts": 2,
	"packages/coding-agent/test/modes/terminal/components/tool-execution-spinner.test.ts": 12,
	"packages/coding-agent/test/modes/terminal/components/welcome.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/utils/context-usage.test.ts": 10,
	"packages/coding-agent/test/modes/terminal/controllers/a-closed-settings-card-lets-go-of-the-clock.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/controllers/a-command-login-lands-in-the-account-manager.test.ts": 3,
	"packages/coding-agent/test/modes/terminal/controllers/a-dismissed-picker-lets-go-of-the-clock.test.ts": 7,
	"packages/coding-agent/test/modes/terminal/controllers/a-toast-is-for-an-unanswered-question.test.ts": 2,
	"packages/coding-agent/test/modes/terminal/controllers/adding-an-account-comes-back-to-the-card.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/controllers/an-overlay-does-not-repaint-the-world.test.ts": 4,
	"packages/coding-agent/test/modes/terminal/controllers/bash-command.test.ts": 1,
	"packages/coding-agent/test/modes/terminal/controllers/btw-controller.test.ts": 14,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-abort-guard.test.ts": 6,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-cwd-changed-reroot.test.ts": 2,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-idle-compaction.test.ts": 8,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-interrupt.test.ts": 3,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-loader-recovery.test.ts": 7,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-message-start.test.ts": 13,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-message-update-repaint.test.ts": 4,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-superseded-agent-end.test.ts": 3,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-todo-never-ran.test.ts": 7,
	"packages/coding-agent/test/modes/terminal/controllers/event-controller-toolcall-finalize.test.ts": 3,
	"packages/coding-agent/test/modes/terminal/controllers/handoff-command.test.ts": 4,
	"packages/coding-agent/test/modes/terminal/controllers/input-controller-tool-expansion.test.ts": 5,
	"packages/coding-agent/test/modes/terminal/controllers/move-command.test.ts": 7,
	"packages/coding-agent/test/modes/terminal/controllers/omfg-controller.test.ts": 7,
	...
	"packages/coding-agent/test/modes/terminal/utils/render-initial-messages.test.ts": 5,
	...
	"packages/coding-agent/test/session/agent-rescope-isolation.test.ts": 1,
	...
	"packages/coding-agent/test/agent-hud-render.test.ts": 2,
	...
	"packages/coding-agent/test/modes/terminal/draw/a-tool-blocks-rail-moves-while-it-runs-and-cools-once-it-lands.test.ts": 4,
	...
	"packages/coding-agent/test/tools/agent/a-vibe-worker-inherits-the-parents-effort-and-policy.test.ts": 3,
	"packages/coding-agent/test/tools/web/search/abort-and-timeout.test.ts": 6,
	"packages/coding-agent/test/tools/web/search/codex-broker.test.ts": 2,
	"packages/coding-agent/test/write-acp-fs.test.ts": 5,
	"plugins/mnemopi/test/beam-store.test.ts": 1,
	"plugins/mnemopi/test/consolidate-fact-id-collision.test.ts": 1,
	"plugins/mnemopi/test/consolidate-fact-sibling-races.test.ts": 1,
	"plugins/mnemopi/test/embedding-failure-logging.test.ts": 4,
	"plugins/mnemopi/test/extraction-wiring.test.ts": 1,
	"plugins/mnemopi/test/fastembed-model-cache.test.ts": 1,
	"plugins/mnemopi/test/optional-embeddings.test.ts": 1,
	"plugins/mnemopi/test/streaming.test.ts": 1,
	"plugins/mnemopi/test/veracity-one-vocabulary.test.ts": 4,
	"apps/stats/test/smoke-worker-darwin.test.ts": 1,
	"apps/stats/test/sync-serial.test.ts": 3,
	"plugins/mode-swarm/src/swarm/__tests__/executor.test.ts": 1,
