 ...
 *
 *   node apps/site/tools/gen-changelog.mjs                 # reconcile against GitHub
 *   node apps/site/tools/gen-changelog.mjs --no-github     # CHANGELOG only (offline)
 *   node apps/site/tools/gen-changelog.mjs --repo owner/name
 *
