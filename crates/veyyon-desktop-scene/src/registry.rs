...
//!
//! The required scene set is `required_state::required_states`, derived from
//! the protocol enums. A state with no registered scene fails completeness
//! validation, preventing UI states from shipping unverified.

use std::collections::{BTreeMap, BTreeSet};

use crate::required_state::{RequiredState, required_states};
...
impl SceneRegistry {
	...
	pub fn new() -> Self {
		...
		let additional = [
			...
			("composer/typing", "composer"),
			("composer/multiline", "composer"),
			("composer/max-height", "composer"),
			("composer/steering", "composer"),
			("composer/aborting", "composer"),
			("composer/disconnected", "composer"),
			("composer/error", "composer"),
			("composer/model-selector", "composer"),
			("composer/thinking-selector", "composer"),
			("opening-line/rest", "opening-line"),
			("run-bar/rest", "run-bar"),
			("palette/rest", "palette"),
			("palette/searching", "palette"),
			("palette/results", "palette"),
			("palette/no-results", "palette"),
			("palette/mode-sessions", "palette"),
			("palette/mode-files", "palette"),
			("palette/content-search", "palette"),
			("palette/mode-browse", "palette"),
			("palette/mode-models", "palette"),
			("settings-row/rest", "settings-row"),
			("shell/auth-needs-secret", "shell"),
			("shell/auth-awaiting-external-url", "shell"),
			("whole-window/rest", "whole-window"),
			("whole-window/populated", "whole-window"),
			("whole-window/streaming", "whole-window"),
			("whole-window/panel-docked", "whole-window"),
			("whole-window/drawer-open", "whole-window"),
			("whole-window/both-open", "whole-window"),
			("whole-window/dialog-up", "whole-window"),
			("whole-window/toast", "whole-window"),
			("whole-window/mid-approval", "whole-window"),
			("whole-window/disconnected", "whole-window"),
			("whole-window/first-run", "whole-window"),
			("drawer/rest", "drawer"),
			("drawer/multiple-terminals", "drawer"),
			("drawer/exited-terminal", "drawer"),
			("drawer/declined", "drawer"),
			("drawer/cjk-and-emoji", "drawer"),
			("drawer/ansi-and-truecolor", "drawer"),
			("drawer/box-drawing-and-progress", "drawer"),
			("drawer/styles-and-cursor", "drawer"),
			("drawer/selection-and-scrollback", "drawer"),
			("drawer/process-supervisor", "drawer"),
		];
