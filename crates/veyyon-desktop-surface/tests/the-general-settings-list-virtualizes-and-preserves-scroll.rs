...
//! 4. Scroll reset on a changed query: narrowing or widening the page draws a
//!    different set of rows, so the offset is put back at the first of them
//!    rather than anchoring an index that now names another setting.
//! 5. Visibility and text remeasurement: Toggling hidden flags or editing copy
