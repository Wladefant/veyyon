...
pub fn load_panels(path: &Path, scale: &ScaleTokens) -> Result<PanelsSurfaceTokens, TokenError> {
	...
	Ok(PanelsSurfaceTokens {
		...
		process_row_height_px: td.spacing("process_row_height_px", scale)?,
		process_dot_px: td.spacing("process_dot_px", scale)?,
		tabs_height_px: tabs.spacing("height_px", scale)?,
		tabs_gap_px: tabs.spacing("gap_px", scale)?,
		tabs_max_width_px: tabs.number("max_width_px")?,
		tabs_close_hit_px: tabs.spacing("close_hit_px", scale)?,
		tabs_pending_dot_px: tabs.spacing("pending_dot_px", scale)?,
		chrome_row_height_px: chrome.number("row_height_px")?,
		chrome_resize_handle_hit_px: chrome.spacing("resize_handle_hit_px", scale)?,
		chrome_resize_handle_line_px: chrome.stroke("resize_handle_line_px", scale)?,
		tree_indent_base_px: tree.spacing("indent_base_px", scale)?,
		tree_indent_step_px: tree.spacing("indent_step_px", scale)?,
		tree_row_height_px: tree.spacing("row_height_px", scale)?,
		...
		diff_sign_width_px: diff.spacing("sign_width_px", scale)?,
