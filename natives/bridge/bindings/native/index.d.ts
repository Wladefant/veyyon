...
export declare class CpuBudgetGroup {
  constructor(options: CpuBudgetCreateOptions)
  /**
 ...
 */
export declare function __veyyonNativesV1_5_3(): void
...
export interface CpuBudgetCreateOptions {
  /**
 ...
 *
 * Uses [`veyyon_iso::IsolationBackend::diff`]'s default implementation —
 ...
 * a hint — see [`veyyon_iso::resolve`] for the exact priority rules.
 */
...
export interface MinimizerOptions {
   ...
   * `None`, defers to the `VEYYON_MINIMIZER_LEGACY_FILTERS` env var.
   */
